...
export default function SafeKakaoMap({ className = '' }: SafeKakaoMapProps) {
  ...
  const addDebugInfo = (info: string) => {
    console.log('SafeKakaoMap Debug:', info)
  ...
  useEffect(() => {
    const initMap = () => {
      ...
      addDebugInfo(`API 키 확인: ${apiKey ? '설정됨' : '설정되지 않음'}`)
